...
namespace CloudChasersSaveManager.Views
{
	...
	/// </summary>
	public class LabelFix : View // FIXME wait for release 0.17
    {
        ...
        /// </summary>
        public LabelFix(int x, int y, ustring text) : this(CalcRect(x, y, text), text)
        {
        }
        ...
        /// </summary>
        public LabelFix(Rect rect, ustring text) : base(rect)
        {
            this.text = text;
        }
        ...
        public LabelFix(ustring text) : base()
        {
            this.text = text;
        ...
        Terminal.Gui.Attribute textColor = -1;
        /// <summary>
        ///   The color used for the label
        /// </summary>        
        public Terminal.Gui.Attribute TextColor
        {
            get => textColor;
            set
            {
